...
class VictorianStyle(HotelStyle):
    ...
    def generate(self, params: BuildingParams, profile: PrinterProfile) -> Manifold:
        ...
        # Main gabled roof
        roof = gabled_roof(w + 0.2, d + 0.2, fh * 0.8)
        ...
        wing_roof = gabled_roof(wing_d + 0.2, wing_w + 0.2, fh * 0.7)
        ...
        bay = box(bay_w, bay_d_proj, bay_h)
        bay = translate(
            bay,
            x=-w / 4,
            y=-d / 2 - bay_d_proj / 2 + BOOLEAN_EMBED,
            z=fh,
        )
